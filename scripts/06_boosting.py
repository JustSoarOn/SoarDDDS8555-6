...
#
# Purpose:
#   Fit and evaluate a Boosting classification model for the
#   NObeyesdad target.
#
#   This script:
...
#     6. Fits a Gradient Boosting classifier.
...
# Boosting model
#
# HistGradientBoostingClassifier provides a robust,
# efficient gradient-boosting implementation.
#
# After one-hot encoding, the feature matrix is converted
# to dense format because this estimator expects dense input.
# ------------------------------------------------------------
...
for artifact in sorted(
    RESULT_DIR.glob("boosting_*.csv")
):
    print(
        artifact.name
    )

print("\n06_boosting.py completed successfully.")
